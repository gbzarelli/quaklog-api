...
class GameImporterUseCaseImplTest {
    ...
    void shouldImportGameWithSuccess() throws IOException, GameParserException {
        ...
        Assertions.assertEquals(game.getGameUUID(), gamesImported.getGames().get(0));
    }
    ...
    void shouldImportGamesWhenTheFirstGameNotHaveShutdownKey() throws IOException, GameParserException {
        ...
        Assertions.assertEquals(game1.getGameUUID(), gamesImported.getGames().get(0));
        Assertions.assertEquals(game2.getGameUUID(), gamesImported.getGames().get(1));
    }
